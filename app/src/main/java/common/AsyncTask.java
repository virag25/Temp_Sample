 ...
 *   Android Authority Apr 27, 2011
 *   This Class is Modified to obtain many Async Task which is not possible with inbuilt android class.
 *   License is attached - Please read that before using it.
 **/
package common;
...
/**
 * The Question - Why I have to create this class my own ? Answer : The default
 * class only provides 10 concurrent Async Process and I do need more, So i have
 * to get this class from the android source code and changed it.
 */
public abstract class AsyncTask<Params, Progress, Result> {
	private static final String LOG_TAG = "SamcomAsyncTask";
